        ...
        <Layout hideFooter={true} type="primary">
            <div className="page__content">
                <article className="article">
                    ...
                    <p>
                        Pony Events Federation e.V.<br/>
                        Poststraße 6<br/>
                        59174 Kamen
                    </p>
                    <p>Represented by</p>
                    <p>Oliver Schmalz, Christoph Friedrich, Lukas Sanders</p>
                    <p><b>Contact</b></p>
                    <p>Telephone: +49 (0) 2307 43 80 210<br/>
                        Fax: +49 (0) 2307 43 85 841<br/>
                        E-Mail: <a href="mailto:info@pony-events.eu">info@pony-events.eu</a><br/>
                        Internetadresse: <a href="http://www.pony-events.eu" target="_blank" rel="noopener">www.pony-events.eu</a></p>
                    <p><b>Register entry</b></p>
                    <p>Entry in Vereinsregister<br/>
                        Register Number: 2265<br/>
                        Register Court: Amtsgericht Hamm</p>
                    <p>Person responsible for content in accordance with 55 Abs. 2 RStV</p>
                    <p>Oliver Schmalz, Christoph Friedrich, Lukas Sanders</p>
                    <p><b>Disclaimer</b></p>
                    ...
                    <p>Newsletter</p>
                    <p>Following subscription to the newsletter, your e-mail address is used for our own advertising purposes until you cancel the newsletter again. Cancellation is possible at any time. The following consent has been expressly granted by you separately, or possibly in the course of an ordering process.<br/>
                        You may revoke your consent at any time with future effect. If you no longer want to receive the newsletter, then unsubscribe via e-mail to info@pony-events.eu.</p>
                    <p>Disclosure</p>
                    <p>According to the Federal Data Protection Act, you have a right to free-of-charge information about your stored data, and possibly entitlement to correction, blocking or deletion of such data. Inquiries can be directed to the following e-mail addresses: ( <a href="mailto:info@pony-events.eu">info@pony-events.eu</a> )</p>
                </article>
            </div>
        </Layout>
    );
